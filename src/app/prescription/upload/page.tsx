...
export default function PrescriptionCreate() {
    ...
    const uploadPrescription = async (id: any) => {
        try {
            ...
            const res = await fetch('http://localhost:3001/prescription/uploadPrescription/' + id, {
                method: 'POST',
                headers: {
    ...
    const showFile = async (id: any) => {
        try {
            ...
            const res = await fetch('http://localhost:3001/prescription/' + id, {
                method: 'GET',
                headers: {
                    'Authorization': sessionStorage.getItem("token") || ''
                },
    ...
    const generatePrescription = async (id: any) => {
        try {
            ...
            const res = await fetch('http://localhost:3001/prescription/generatePrescription/' + id, {
                method: 'GET',
                headers: {
                    'Authorization': sessionStorage.getItem("token") || ''
                },
